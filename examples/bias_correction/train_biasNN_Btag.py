...
# label_var = 'eventExtraInfo__bocombined__miwideCNN_2018__pt11__pt04__pt21__pt03__bc'
...
if __name__ == '__main__':
    ...
    NN_model.model.save(os.path.join(args.out_dir, 'biasNN_model.h5'))
